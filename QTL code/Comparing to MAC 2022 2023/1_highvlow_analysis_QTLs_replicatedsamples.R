...
#vcf files from the 2022 and 2023 papers were used and analyzed starting with this script for the current paper
...
comp_table     <- paste0(proj_dir, "2024.07.18_comparison_table_maccompare.txt")
#make a name of file you want for the output of the median coverage
medcovtable <- paste0(proj_dir, "mac_coverage_table_24.07.18.txt")
#################
## END USER INPUT
#################
